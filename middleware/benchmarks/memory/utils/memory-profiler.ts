...
export class MemoryProfiler {
   ...
   */
  forceMultipleGC(attempts: number = 3): void {
   ...
   */
  analyzeDifference(before: MemorySnapshot, after: MemorySnapshot): {
    heapGrowthMB: number;
    heapGrowthPercent: number;
    rssGrowthMB: number;
   ...
   */
  detectMemoryLeak(baseline: MemorySnapshot, afterTest: MemorySnapshot): boolean {
   ...
   */
  generateReport(result: MemoryTestResult): string {
