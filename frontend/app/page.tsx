      ...
      <div className="flex flex-col items-center max-w-sm w-full space-y-8">
        ...
        <div className="relative mb-8">
          <div className="w-32 h-32 rounded-full  flex items-center justify-center shadow-2xl">
            <Image src="/logo.png" className='w-full h-full object-contain' alt="Brain Icon" width={64} height={64} />
          </div>
        ...
        <div className="w-full space-y-4 pt-8 ">
          <button className="w-full bg-blue-500 border-b-4 border-blue-700 hover:bg-blue-600 text-white font-semibold py-4 px-6 rounded-xl transition-colors duration-200 shadow-lg">
            Register & Play
          </button>
          
          <div className="text-center">
            <span className="text-gray-400 text-sm">Have an account? </span>
            <button className="text-blue-400 text-sm hover:text-blue-300 font-medium transition-colors duration-200">
              Sign in
            </button>
          </div>
        </div>
