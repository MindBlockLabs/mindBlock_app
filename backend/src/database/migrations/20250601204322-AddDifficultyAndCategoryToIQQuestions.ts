...
export class AddDifficultyAndCategoryToIQQuestions20250601204322 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Drop indexes
    await queryRunner.query(`DROP INDEX "IDX_iq_questions_difficulty_category"`)
    ...
    // Drop columns
    await queryRunner.query(`ALTER TABLE "iq_questions" DROP COLUMN "category"`)
    await queryRunner.query(`ALTER TABLE "iq_questions" DROP COLUMN "difficulty"`)
