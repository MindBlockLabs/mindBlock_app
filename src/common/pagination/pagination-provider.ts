...
import { PaginatedInterface } from '../interfaces/paginatedInterfaces';
...
export class PaginationProvider {
  ...
  public async qpaginatedQuer<T extends ObjectLiteral>(
    ...
    const nextPage = paginatedQueryDto.page === totalPages ? paginatedQueryDto.page : paginatedQueryDto.page + 1 
    const prevPage = paginatedQueryDto.page === 1 ? paginatedQueryDto.page : paginatedQueryDto.page - 1
