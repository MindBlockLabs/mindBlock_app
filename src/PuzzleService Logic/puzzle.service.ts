...
export class PuzzleService {
  ...
  private calculateRewards(difficulty: PuzzleDifficulty): { xpEarned: number; tokensEarned: number } {
    return {
      xpEarned: XP_BY_DIFFICULTY[difficulty as keyof typeof XP_BY_DIFFICULTY],
      tokensEarned: TOKENS_BY_DIFFICULTY[difficulty as keyof typeof TOKENS_BY_DIFFICULTY],
    };
  }
